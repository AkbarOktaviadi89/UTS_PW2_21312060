...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('21312060_uts2', function (Blueprint $table) {
            ...
            $table->foreign('id_uts1')->references('id')->on('21312060_uts1');
            $table->foreign('id_uts3')->references('id')->on('21312060_uts3');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('21312060_uts2');
    }
};
